...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Extension.is_condition'
        db.add_column('dialplan_extension', 'is_condition', orm['dialplan.extension:is_condition'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Extension.is_condition'
        db.delete_column('dialplan_extension', 'is_condition')
