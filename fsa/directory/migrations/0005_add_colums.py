...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Endpoint.cidr_ip'
        db.add_column('endpoints', 'cidr_ip', self.gf('django.db.models.fields.IPAddressField')(default='0.0.0.0', max_length=15), keep_default=False)

        # Adding field 'Endpoint.cidr_mask'
        db.add_column('endpoints', 'cidr_mask', self.gf('django.db.models.fields.SmallIntegerField')(default=32), keep_default=False)

        # Adding field 'Endpoint.mac_adress'
        db.add_column('endpoints', 'mac_adress', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Endpoint.max_calls'
        db.add_column('endpoints', 'max_calls', self.gf('django.db.models.fields.SmallIntegerField')(default=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Endpoint.cidr_ip'
        db.delete_column('endpoints', 'cidr_ip')

        # Deleting field 'Endpoint.cidr_mask'
        db.delete_column('endpoints', 'cidr_mask')

        # Deleting field 'Endpoint.mac_adress'
        db.delete_column('endpoints', 'mac_adress')

        # Deleting field 'Endpoint.max_calls'
        db.delete_column('endpoints', 'max_calls')
    ...
    models = {
        ...
        'server.server': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'sipsites'", 'blank': 'True', 'null': 'True', 'to': "orm['sites.Site']"}),
