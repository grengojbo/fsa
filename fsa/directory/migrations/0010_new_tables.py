...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Endpoint.phone_redirect_type'
        db.add_column('endpoints', 'phone_redirect_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Endpoint.phone_redirect_type'
        db.delete_column('endpoints', 'phone_redirect_type')
    ...
    models = {
        ...
        'directory.endpoint': {
            ...
            'phone_redirect_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            ...
            'srtp': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'zrtp': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'directory.fsgroup': {
