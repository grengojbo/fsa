...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Endpoint.other_param'
        db.add_column('endpoints', 'other_param', self.gf('django.db.models.fields.XMLField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Endpoint.other_param'
        db.delete_column('endpoints', 'other_param')
    ...
    models = {
        ...
        'directory.endpoint': {
            ...
            'other_param': ('django.db.models.fields.XMLField', [], {'null': 'True', 'blank': 'True'}),
