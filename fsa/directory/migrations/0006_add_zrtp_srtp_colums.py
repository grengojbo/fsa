...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Endpoint.zrtp'
        db.add_column('endpoints', 'zrtp', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Endpoint.srtp'
        db.add_column('endpoints', 'srtp', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Endpoint.zrtp'
        db.delete_column('endpoints', 'zrtp')

        # Deleting field 'Endpoint.srtp'
        db.delete_column('endpoints', 'srtp')
