...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Endpoint.password'
        db.alter_column('endpoints', 'password', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Endpoint.password'
        db.alter_column('endpoints', 'password', self.gf('django.db.models.fields.CharField')(max_length=6, blank=True))
