...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('endpoints', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uid', self.gf('django.db.models.fields.CharField')(max_length=12, unique=True, blank=True)),
            ('phone_type', self.gf('django.db.models.fields.CharField')(default='S', max_length=1)),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=6, blank=True)),
            ('accountcode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('user_context', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dialplan.Context'])),
            ('sip_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.SipProfile'])),
            ('effective_caller_id_name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('enable', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('is_registered', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('last_registered', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(default='sip number', max_length=255, blank=True)),
        ))
        db.send_create_signal('directory', ['Endpoint'])

        # Adding model 'SipRegistration'
        db.create_table('sip_reg', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('domain', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.Endpoint'])),
            ('ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('sip_auth_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('sip_auth_method', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('sip_auth_nonce', self.gf('django.db.models.fields.CharField')(max_length=36, unique=True)),
            ('sip_auth_qop', self.gf('django.db.models.fields.CharField')(default='auth', max_length=100)),
            ('sip_auth_realm', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sip_auth_uri', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sip_auth_cnonce', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('sip_auth_response', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('sip_user_agent', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('sip_from_user', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('sip_from_host', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sip_to_user', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('sip_to_host', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sip_contact_user', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('sip_contact_host', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('sip_request_host', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('directory', ['SipRegistration'])

        # Adding model 'FSGroup'
        db.create_table('endpoints_group', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True)),
        ))
        db.send_create_signal('directory', ['FSGroup'])

        # Adding M2M table for field users on 'FSGroup'
        db.create_table('endpoint_to_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fsgroup', models.ForeignKey(orm['directory.fsgroup'], null=False)),
            ('endpoint', models.ForeignKey(orm['directory.endpoint'], null=False))
        ))
        db.create_unique('endpoint_to_groups', ['fsgroup_id', 'endpoint_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SipRegistration'
        db.delete_table('sip_reg')

        # Deleting model 'FSGroup'
        db.delete_table('endpoints_group')

        # Removing M2M table for field users on 'FSGroup'
        db.delete_table('endpoint_to_groups')
