...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('endpoints_group', (
            ('id', orm['directory.FSGroup:id']),
            ('name', orm['directory.FSGroup:name']),
        ))
        db.send_create_signal('directory', ['FSGroup'])
        
        # Adding model 'SipRegistration'
        db.create_table('sip_reg', (
            ('id', orm['directory.SipRegistration:id']),
            ('domain', orm['directory.SipRegistration:domain']),
            ('user', orm['directory.SipRegistration:user']),
            ('ip', orm['directory.SipRegistration:ip']),
            ('sip_auth_username', orm['directory.SipRegistration:sip_auth_username']),
            ('sip_auth_method', orm['directory.SipRegistration:sip_auth_method']),
            ('sip_auth_nonce', orm['directory.SipRegistration:sip_auth_nonce']),
            ('sip_auth_qop', orm['directory.SipRegistration:sip_auth_qop']),
            ('sip_auth_realm', orm['directory.SipRegistration:sip_auth_realm']),
            ('sip_auth_uri', orm['directory.SipRegistration:sip_auth_uri']),
            ('sip_auth_cnonce', orm['directory.SipRegistration:sip_auth_cnonce']),
            ('sip_auth_response', orm['directory.SipRegistration:sip_auth_response']),
            ('sip_user_agent', orm['directory.SipRegistration:sip_user_agent']),
            ('sip_from_user', orm['directory.SipRegistration:sip_from_user']),
            ('sip_from_host', orm['directory.SipRegistration:sip_from_host']),
            ('sip_to_user', orm['directory.SipRegistration:sip_to_user']),
            ('sip_to_host', orm['directory.SipRegistration:sip_to_host']),
            ('sip_contact_user', orm['directory.SipRegistration:sip_contact_user']),
            ('sip_contact_host', orm['directory.SipRegistration:sip_contact_host']),
            ('sip_request_host', orm['directory.SipRegistration:sip_request_host']),
        ))
        db.send_create_signal('directory', ['SipRegistration'])
        
        # Adding model 'Endpoint'
        db.create_table('endpoints', (
            ('id', orm['directory.Endpoint:id']),
            ('uid', orm['directory.Endpoint:uid']),
            ('phone_type', orm['directory.Endpoint:phone_type']),
            ('password', orm['directory.Endpoint:password']),
            ('accountcode', orm['directory.Endpoint:accountcode']),
            ('user_context', orm['directory.Endpoint:user_context']),
            ('sip_profile', orm['directory.Endpoint:sip_profile']),
            ('effective_caller_id_name', orm['directory.Endpoint:effective_caller_id_name']),
            ('enable', orm['directory.Endpoint:enable']),
            ('is_registered', orm['directory.Endpoint:is_registered']),
            ('last_registered', orm['directory.Endpoint:last_registered']),
            ('description', orm['directory.Endpoint:description']),
        ))
        db.send_create_signal('directory', ['Endpoint'])
        
        # Adding ManyToManyField 'FSGroup.users'
        db.create_table('endpoint_to_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fsgroup', models.ForeignKey(orm.FSGroup, null=False)),
            ('endpoint', models.ForeignKey(orm.Endpoint, null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        # Dropping ManyToManyField 'FSGroup.users'
