...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Endpoint.phone_alias'
        db.add_column('endpoints', 'phone_alias', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True), keep_default=False)

        # Adding field 'Endpoint.phone_redirect'
        db.add_column('endpoints', 'phone_redirect', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Endpoint.phone_alias'
        db.delete_column('endpoints', 'phone_alias')

        # Deleting field 'Endpoint.phone_redirect'
        db.delete_column('endpoints', 'phone_redirect')
    ...
    models = {
        ...
        'directory.sipregistration': {
            ...
            'sip_auth_nonce': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '36'}),
