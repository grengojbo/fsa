...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Endpoint.other_variable'
        db.add_column('endpoints', 'other_variable', self.gf('django.db.models.fields.XMLField')(default='<!-- other_variable -->', null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Endpoint.other_variable'
        db.delete_column('endpoints', 'other_variable')
    ...
    models = {
        ...
        'directory.endpoint': {
            ...
            'other_param': ('django.db.models.fields.XMLField', [], {'default': "'<!-- other_param -->'", 'null': 'True', 'blank': 'True'}),
            'other_variable': ('django.db.models.fields.XMLField', [], {'default': "'<!-- other_variable -->'", 'null': 'True', 'blank': 'True'}),
