...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Lcr.date_end'
        db.delete_column('lcr', 'date_end')

        # Adding field 'Lcr.code'
        db.add_column('lcr', 'code', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Changing field 'Lcr.date_start'
        db.alter_column('lcr', 'date_start', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Adding field 'Lcr.date_end'
        db.add_column('lcr', 'date_end', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(9999, 12, 31, 23, 59, 59, 999999)), keep_default=False)

        # Deleting field 'Lcr.code'
        db.delete_column('lcr', 'code')

        # Changing field 'Lcr.date_start'
        db.alter_column('lcr', 'date_start', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'lcr.lcr': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2010, 12, 14, 13, 1, 21, 118189)'}),
