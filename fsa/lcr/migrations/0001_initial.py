...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lcr', (
            ...
            ('rate', self.gf('bursar.fields.CurrencyField')(default='0.0', max_digits=18, decimal_places=4)),
            ('intrastate_rate', self.gf('bursar.fields.CurrencyField')(default='0.0', max_digits=18, decimal_places=4)),
            ('intralata_rate', self.gf('bursar.fields.CurrencyField')(default='0.0', max_digits=18, decimal_places=4)),
            ...
            ('carrier_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gateway.SofiaGateway'])),
            ('lead_strip', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('trail_strip', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('lcr_profile', self.gf('django.db.models.fields.CharField')(max_length=96, blank=True)),
            ('date_start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 11, 21, 15, 1, 26, 511907))),
            ('date_end', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(9999, 12, 31, 23, 59, 59, 999999))),
            ('quality', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('reliability', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('cid', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
    ...
    models = {
        ...
        'lcr.lcr': {
            ...
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 21, 15, 1, 26, 511907)'}),
            'digits': ('django.db.models.fields.CharField', [], {'max_length': '45', 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intralata_rate': ('bursar.fields.CurrencyField', [], {'default': "'0.0'", 'max_digits': '18', 'decimal_places': '4'}),
            'intrastate_rate': ('bursar.fields.CurrencyField', [], {'default': "'0.0'", 'max_digits': '18', 'decimal_places': '4'}),
            ...
            'rate': ('bursar.fields.CurrencyField', [], {'default': "'0.0'", 'max_digits': '18', 'decimal_places': '4'}),
