...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lcr.operator_type'
        db.add_column('lcr', 'operator_type', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lcr.operator_type'
        db.delete_column('lcr', 'operator_type')
    ...
    models = {
        ...
        'lcr.lcr': {
            ...
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 21, 15, 3, 24, 192169)'}),
