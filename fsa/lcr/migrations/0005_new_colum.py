...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lcr.direction'
        db.add_column('lcr', 'direction', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lcr.direction'
        db.delete_column('lcr', 'direction')
    ...
    models = {
        ...
        'lcr.lcr': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 17)'}),
