...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Server.ssh_password'
        db.delete_column('server', 'ssh_password')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Server.ssh_password'
        db.add_column('server', 'ssh_password', orm['server.server:ssh_password'])
