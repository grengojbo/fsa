...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sip_profile_sites', (
            ...
            ('sipprofile', models.ForeignKey(orm['server.sipprofile'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('sip_profile_sites', ['sipprofile_id', 'site_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field sites on 'SipProfile'
        db.delete_table('sip_profile_sites')
