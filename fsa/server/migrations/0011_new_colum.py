...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NumberGroup.number_start'
        db.alter_column('number_group', 'number_start', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'NumberGroup.number_end'
        db.alter_column('number_group', 'number_end', self.gf('django.db.models.fields.BigIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'NumberGroup.number_start'
        db.alter_column('number_group', 'number_start', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'NumberGroup.number_end'
        db.alter_column('number_group', 'number_end', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'server.numbergroup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '50'}),
            'number_end': ('django.db.models.fields.BigIntegerField', [], {'default': '1010'}),
            'number_start': ('django.db.models.fields.BigIntegerField', [], {'default': '1000'})
        },
        'server.server': {
