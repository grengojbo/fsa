...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CsvBase'
        db.create_table('CsvBase', (
            ('id', orm['server.csvbase:id']),
            ('name', orm['server.csvbase:name']),
            ('val', orm['server.csvbase:val']),
            ('description', orm['server.csvbase:description']),
        ))
        db.send_create_signal('server', ['CsvBase'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'CsvBase'
        db.delete_table('CsvBase')
