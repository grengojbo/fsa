...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SipProfile.default_profile'
        db.add_column('sip_profile', 'default_profile', orm['server.sipprofile:default_profile'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SipProfile.default_profile'
        db.delete_column('sip_profile', 'default_profile')
