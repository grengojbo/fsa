...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cdr.lcr_rate'
        db.add_column(u'cdr', 'lcr_rate', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=18, decimal_places=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cdr.lcr_rate'
        db.delete_column(u'cdr', 'lcr_rate')
