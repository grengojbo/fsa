...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cdr.cash'
        db.add_column(u'cdr', 'cash', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=18, decimal_places=2), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Cdr.cash'
        db.delete_column(u'cdr', 'cash')
