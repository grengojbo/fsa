...
class CdrHandler(PaginatedCollectionBaseHandler):
    ...
    fields = ('username', 'phone', 'destination_number', 'billsec', 'cash', 'start_timestamp', 'hangup_cause', 'direction', 'lcr_rate', 'nibble_rate', 'answer_timestamp', 'end_timestamp', 'ipaddr',)
    ...
    def create(self, request):
        ...
        if xml_cdr.cdr.variables.lcr_direction is not None and xml_cdr.cdr.variables.lcr_direction.string == 'in':
            ...
            #elif xml_cdr.cdr.variables.lcr_direction.string == 'out':
            new_cdr.direction = 2
