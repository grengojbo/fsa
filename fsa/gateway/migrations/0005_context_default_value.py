...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SofiaGateway.context'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['dialplan.Context']))
        db.alter_column('carrier_gateway', 'context_id', orm['gateway.sofiagateway:context'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SofiaGateway.context'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['dialplan.Context'], blank=True))
        db.alter_column('carrier_gateway', 'context_id', orm['gateway.sofiagateway:context'])
