...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SofiaGateway.money_time'
        db.add_column('carrier_gateway', 'money_time', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=60), keep_default=False)

        # Adding field 'SofiaGateway.money_nds'
        db.add_column('carrier_gateway', 'money_nds', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=20), keep_default=False)

        # Adding field 'SofiaGateway.money_period'
        db.add_column('carrier_gateway', 'money_period', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SofiaGateway.money_time'
        db.delete_column('carrier_gateway', 'money_time')

        # Deleting field 'SofiaGateway.money_nds'
        db.delete_column('carrier_gateway', 'money_nds')

        # Deleting field 'SofiaGateway.money_period'
        db.delete_column('carrier_gateway', 'money_period')
