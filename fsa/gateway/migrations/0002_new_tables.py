...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SofiaGateway.price'
        db.add_column('carrier_gateway', 'price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=18, decimal_places=4), keep_default=False)

        # Adding field 'SofiaGateway.price_currency'
        db.add_column('carrier_gateway', 'price_currency', self.gf('django.db.models.fields.CharField')(default='USD', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SofiaGateway.price'
        db.delete_column('carrier_gateway', 'price')

        # Deleting field 'SofiaGateway.price_currency'
        db.delete_column('carrier_gateway', 'price_currency')
