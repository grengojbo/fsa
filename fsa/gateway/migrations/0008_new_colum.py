...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SofiaGateway.destination_number'
        db.add_column('carrier_gateway', 'destination_number', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SofiaGateway.destination_number'
        db.delete_column('carrier_gateway', 'destination_number')
