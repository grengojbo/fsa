...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SofiaGateway.pref_international'
        db.add_column('carrier_gateway', 'pref_international', self.gf('django.db.models.fields.CharField')(default='', max_length=5), keep_default=False)

        # Adding field 'SofiaGateway.pref_national'
        db.add_column('carrier_gateway', 'pref_national', self.gf('django.db.models.fields.CharField')(default='', max_length=5), keep_default=False)

        # Adding field 'SofiaGateway.prefix_number'
        db.add_column('carrier_gateway', 'prefix_number', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SofiaGateway.pref_international'
        db.delete_column('carrier_gateway', 'pref_international')

        # Deleting field 'SofiaGateway.pref_national'
        db.delete_column('carrier_gateway', 'pref_national')

        # Deleting field 'SofiaGateway.prefix_number'
        db.delete_column('carrier_gateway', 'prefix_number')
    ...
    models = {
        ...
        'gateway.sofiagateway': {
            ...
            'pref_international': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '5'}),
            'pref_national': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '5'}),
