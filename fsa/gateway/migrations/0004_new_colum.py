...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SofiaGateway.codec_string'
        db.add_column('carrier_gateway', 'codec_string', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SofiaGateway.codec_string'
        db.delete_column('carrier_gateway', 'codec_string')
    ...
    models = {
        ...
        'gateway.sofiagateway': {
            ...
            'codec_string': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
