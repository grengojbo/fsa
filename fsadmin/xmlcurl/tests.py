...
##         mod_xml_curl.c:304 Received HTTP error 500 trying to fetch http://192.168.122.105:8001/api/get/
##         data: [hostname=sip&section=directory&tag_name=domain&key_name=name&key_value=195.5.22.146&Event-Name=GENERAL&Core-UUID=fc6796e2-5627-11df-91a6-61df35aaf424&FreeSWITCH-Hostname=sip&FreeSWITCH-IPv4=195.5.22.146&FreeSWITCH-IPv6=2001%3A470%3A1f0a%3A1017%3A%3A2&Event-Date-Local=2010-05-02%2023%3A22%3A25&Event-Date-GMT=Sun,%2002%20May%202010%2020%3A22%3A25%20GMT&Event-Date-Timestamp=1272831745444234&Event-Calling-File=mod_voicemail.c&Event-Calling-Function=resolve_id&Event-Calling-Line-Number=1242&action=message-count&key=id&user=1000&domain=195.5.22.146]
##2010-05-02 23:24:16.495989 [ERR] mod_xml_curl.c:304 Received HTTP error 500 trying to fetch http://192.168.122.105:8001/api/get/
...
##2010-05-02 23:24:28.735106 [ERR] mod_xml_cdr.c:359 Got error [401] posting to web server [http://192.168.122.105:8001/api/cdr/]
##2010-05-02 23:24:28.735106 [ERR] mod_xml_cdr.c:366 Retry will be with url [http://192.168.122.105:8001/api/cdr/]
##2010-05-02 23:24:28.735106 [ERR] mod_xml_cdr.c:377 Unable to post to web server, writing to file
##2010-05-02 23:25:41.325661 [ERR] mod_xml_curl.c:304 Received HTTP error 500 trying to fetch http://192.168.122.105:8001/api/get/
